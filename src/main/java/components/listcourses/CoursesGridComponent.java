...
public class CoursesGridComponent extends AbsBaseComponent {
    ...
    private String coursesName ="//div[contains(text(), 'Каталог')]//ancestor::section//a[contains(@href,'/lessons/%s')]";
    ...
    public void coursesClick (CoursesData coursesData) {
        String locator = String.format(coursesName, coursesData.getName());
